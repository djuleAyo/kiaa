...
int main()
{
     ...
     graf[5].adj.push_back(1);
     cap[1][5] = 1;

     graf[2].adj.push_back(6);
     graf[6].adj.push_back(2);
     cap[2][6] = 1;
     ...
     graf[6].adj.push_back(7);
     graf[7].adj.push_back(6);
     cap[6][7] = 1;

     if (EdmondsKarp() > 1) {
       printf("Profesor Krstic moze poslati decu u skolu! :)\n");
     }
     else {
       printf("Profesor Krstic ne moze poslati decu u skolu! :(\n");
     }
